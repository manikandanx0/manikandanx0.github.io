    ...
    <div className="container mx-auto px-4 py-16 space-y-12">
      ...
      <div className="grid lg:grid-cols-2 gap-12">
        ...
        <Card className="bg-card/50 border-border">
          <CardHeader>
            <CardTitle className="font-mono text-2xl">Send a Message</CardTitle>
            <CardDescription>
        ...
        <div className="space-y-8">
          ...
          <Card className="bg-card/50 border-border">
            <CardHeader>
              ...
              <CardDescription>
                Prefer a more direct approach? Here's how to reach me.
              </CardDescription>
            </CardHeader>
          ...
          <Card className="bg-card/50 border-border">
            <CardHeader>
              <CardTitle className="font-mono text-2xl">Connect Online</CardTitle>
              <CardDescription>
          ...
          <Card className="bg-card/50 border-border">
            <CardHeader>
              <CardTitle className="font-mono text-2xl">Current Availability</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
